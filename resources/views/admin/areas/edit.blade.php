        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit area - {{ $item->title }}</li>
                </ol>
            </div>
            <h4 class="page-title">Edit area - {{ $item->title }}</h4>
        </div>
    </div>
</div>
<!-- end page title -->
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Edit area - {{ $item->title }}</h4>
                <p class="text-muted font-13">Edit area - {{ $item->title }}</p>
                <!--begin::Form-->
