        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Edit School Note - {{ $item->notes }}</li>
                </ol>
            </div>
            <h4 class="page-title">Edit School Note - {{ $item->notes }}</h4>
        </div>
    </div>
</div>
<!-- end page title -->
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Edit School Note - {{ $item->notes }}</h4>
                <p class="text-muted font-13">Edit School Note - {{ $item->notes }}</p>
                <!--begin::Form-->
