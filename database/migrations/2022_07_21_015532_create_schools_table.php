...
class CreateSchoolsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('schools', function (Blueprint $table) {
            ...
            $table->enum('online_student_portal', ['Yes', 'No'])->default('No');
            $table->text('name_of_the_system');
            $table->date('contract_till');
            ...
            $table->unsignedBigInteger('telemarketing_rep_id');
